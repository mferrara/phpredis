...
#define arginfo_class_Redis_vgetattr arginfo_class_Redis_vsetattr

#define arginfo_class_Redis_vcard arginfo_class_Redis__prefix

#define arginfo_class_Redis_vdim arginfo_class_Redis__prefix
